  ...
  <section class="total-investment" id="scenario">
    <div class="container">
      ...
      <div class="checkout-card" data-reveal>
        <div v-for="row in rows" :key="row.label" class="checkout-row">
          <div class="label">
        ...
        <div class="checkout-total">
          ...
          <div class="amount-big">44.500 €</div>
        </div>
...
.total-investment :deep(.eyebrow) { color: var(--electric-glow); }
.total-investment :deep(.eyebrow::before) { background: var(--electric-glow); }
